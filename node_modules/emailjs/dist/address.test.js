...
describe('addressparser', () => {
    ...
    it('should handle address group correctly', () => {
        expect(addressparser('Disclosed:andris@tr.ee, andris@example.com;')).toEqual([
            {
                name: 'Disclosed',
                group: [
                    { address: 'andris@tr.ee', name: '' },
    ...
    it('should handle mixed group correctly', () => {
        expect(addressparser('Test User <test.user@mail.ee>, Disclosed:andris@tr.ee, andris@example.com;,,,, Undisclosed:;')).toEqual([
    ...
    it('semicolon as delimiter should not break group parsing ', () => {
        expect(addressparser('Test User <test.user@mail.ee>; Disclosed:andris@tr.ee, andris@example.com;,,,, Undisclosed:; bob@example.com;')).toEqual([
            { address: 'test.user@mail.ee', name: 'Test User' },
            {
                name: 'Disclosed',
                group: [
    ...
    it('should handle particularly bad input, unescaped colon correctly', () => {
        expect(addressparser('FirstName Surname-WithADash :: Company <firstname@company.com>')).toEqual([
            {
